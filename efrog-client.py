...
##### SEND GET ICONNECT DATA #######
        ...
        class Player:
            ...
            def move(self):
                ...
                if (gameRunning!=False):
                    ...
                    my_move_x = self.x
                    my_move_y = self.y
                    my_move_coord = str(my_move_x)+","+str(my_move_y)

                    iConnect_sock.send(my_move_coord.encode('ascii')) # send my position to Opponent

                    #print("Move x of 1 "+str(my_move_x)+"Move y of 1 "+str(my_move_y))
      ...
      # start receiving/sending data from the opponents
        ...
        while(gameRunning!=False):
            ...
            camera.zoom = .2 #updated for steady zoom - recommeneded is 5
